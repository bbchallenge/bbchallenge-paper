...
\begin{algorithm}
    ...
    \begin{algorithmic}[1]
        ...
        \State Set $c'.\text{\leftngram}$ to the last $n-1$ symbols of $c.\text{\leftngram}$ followed by $w$
        \State Set $c'.\text{\middlesymbol}$ to the first symbol of $c.\text{\rightngram}$
        \For{each ngram $r\in R$ starting with the last $n-1$ symbols of $c.\text{\rightngram}$}
        ...
        \State Set $c'.\text{\rightngram}$ to the first $n-1$ symbols of $c.\text{\rightngram}$ preceded by $w$
        \State Set $c'.\text{\middlesymbol}$ to the last symbol of $c.\text{\leftngram}$
        \For{each ngram $l \in L$ ending with the first $n-1$ symbols of $c.\text{\leftngram}$}
