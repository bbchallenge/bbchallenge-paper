...
% the collision between the world of mathematics and software development is also particularly apparent as the proof is a collection of algorithms proven correct (see Section~\ref{sec:intro:mainresults}).
...
% translated counters: 1RB0RA_1LC0LD_1RE1RD_1LA1LB_---1RC
