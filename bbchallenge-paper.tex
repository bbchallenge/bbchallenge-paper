...
% --- Make footnote marks zero-height for the title page only ---
\makeatletter
\let\orig@makefnmark\@makefnmark
\renewcommand\@makefnmark{\hbox{\smash{\@textsuperscript{\normalfont\@thefnmark}}}}
\makeatother

\maketitle

% --- Restore normal footnote marks for the rest of the document ---
\makeatletter
